namespace AirScrewPlugin.Model.Tests
{
    ...
    public class ValidatorTest
    {
        ...
        /// </summary>
        /// <param name="srtingOnlyNumber">Строка только цифры.</param>
        ...
        public void Validate_DoCheckParameter_ReturnsOnlyNumber(string srtingOnlyNumber, string stringNotOnlyNumber)
        {
            // Arrange
            string expected = srtingOnlyNumber;
